...
image = cv2.imread("./src/cuda-tensorrt-basic-api/static/kej.jpg")
...
labels = open("./src/cuda-tensorrt-basic-api/static/labels.imagenet.txt", encoding="utf-8").readlines()
...
torch.onnx.export(
    model, (dummy,), "./src/cuda-tensorrt-basic-api/static/classifier.onnx", 
    input_names=["image"], 
    output_names=["prob"], 
